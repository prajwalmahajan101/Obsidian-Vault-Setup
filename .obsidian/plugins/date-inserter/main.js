...
var SettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Date format").setDesc("Date format to be inserted.").addText((text) => text.setPlaceholder("mm/dd/yyyy").setValue(this.plugin.settings.format).onChange(async (value) => {
    ...
    new import_obsidian.Setting(containerEl).setName("Language").setDesc("Set calendar and date-related languages.").addDropdown((dropdown) => dropdown.addOptions(LANGUAGES).setValue(this.plugin.settings.language).onChange(async (value) => {
      this.plugin.settings.language = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian.Setting(containerEl).setName("Week start").setDesc("Start day of the week.").addDropdown((dropdown) => dropdown.addOptions({
    ...
    new import_obsidian.Setting(containerEl).setName("Highlight the today").setDesc("Whether to highlight the today.").addToggle(
      (toggle) => toggle.setValue(this.plugin.settings.todayHighlight).onChange(async (value) => {
        this.plugin.settings.todayHighlight = value;
        await this.plugin.saveData(this.plugin.settings);
      })
    );
    new import_obsidian.Setting(containerEl).setName("Highlight days of week").setDesc("Days of the week to highlight in the calendar.");
    containerEl.createDiv("setting-day-of-week", (el) => {
      new import_obsidian.Setting(el).setDesc("Sunday").addToggle((toggle) => toggle.setValue(this.plugin.settings.daysOfWeekHighlighted.sun === DAY_OF_WEEK.sun).onChange(async (value) => {
        this.plugin.settings.daysOfWeekHighlighted.sun = value ? DAY_OF_WEEK.sun : void 0;
        await this.plugin.saveSettings();
      }));
      new import_obsidian.Setting(el).setDesc("Monday").addToggle((toggle) => toggle.setValue(this.plugin.settings.daysOfWeekHighlighted.mon === DAY_OF_WEEK.mon).onChange(async (value) => {
        this.plugin.settings.daysOfWeekHighlighted.mon = value ? DAY_OF_WEEK.mon : void 0;
        await this.plugin.saveSettings();
      }));
      new import_obsidian.Setting(el).setDesc("Tuesday").addToggle((toggle) => toggle.setValue(this.plugin.settings.daysOfWeekHighlighted.tue === DAY_OF_WEEK.tue).onChange(async (value) => {
        this.plugin.settings.daysOfWeekHighlighted.tue = value ? DAY_OF_WEEK.tue : void 0;
        await this.plugin.saveSettings();
      }));
      new import_obsidian.Setting(el).setDesc("Wednesday").addToggle((toggle) => toggle.setValue(this.plugin.settings.daysOfWeekHighlighted.wed === DAY_OF_WEEK.wed).onChange(async (value) => {
        this.plugin.settings.daysOfWeekHighlighted.wed = value ? DAY_OF_WEEK.wed : void 0;
        await this.plugin.saveSettings();
      }));
      new import_obsidian.Setting(el).setDesc("Thursday").addToggle((toggle) => toggle.setValue(this.plugin.settings.daysOfWeekHighlighted.thu === DAY_OF_WEEK.thu).onChange(async (value) => {
        this.plugin.settings.daysOfWeekHighlighted.thu = value ? DAY_OF_WEEK.thu : void 0;
        await this.plugin.saveSettings();
      }));
      new import_obsidian.Setting(el).setDesc("Friday").addToggle((toggle) => toggle.setValue(this.plugin.settings.daysOfWeekHighlighted.fri === DAY_OF_WEEK.fri).onChange(async (value) => {
        this.plugin.settings.daysOfWeekHighlighted.fri = value ? DAY_OF_WEEK.fri : void 0;
        await this.plugin.saveSettings();
      }));
      new import_obsidian.Setting(el).setDesc("Saturday").addToggle((toggle) => toggle.setValue(this.plugin.settings.daysOfWeekHighlighted.sat === DAY_OF_WEEK.sat).onChange(async (value) => {
        this.plugin.settings.daysOfWeekHighlighted.sat = value ? DAY_OF_WEEK.sat : void 0;
        await this.plugin.saveSettings();
      }));
    });
  }
...
var CalendarModal = class extends import_obsidian2.Modal {
  ...
  insertDateToCursorPosition(date) {
  ...
  generateOptions(settings) {
    ...
    const daysOfWeekHighlighted = [sun, mon, tue, wed, thu, fri, sat].filter((val) => val !== void 0);
    const options = {
...
// src/main.ts
var DateInserter = class extends import_obsidian3.Plugin {
  async onload() {
